"""
Top-level script to run the complete VLA system.
This script initializes all components and starts the main system loop.
"""
import asyncio
import logging
import signal
...
from src.shared.utils.logging import setup_logging, get_logger
from src.shared.config.config import get_config
from src.vla.voice_interface.transcription_service import get_transcription_service_manager
from src.vla.voice_interface.microphone_handler import get_microphone_input_handler
from src.vla.voice_interface.speech_recognition import get_speech_recognition_interface
from src.shared.utils.state_manager import get_global_state_manager
from src.shared.utils.llm_client import get_llm_client
from src.shared.utils.audio_utils import get_audio_processor
from src.shared.utils.math_utils import (
